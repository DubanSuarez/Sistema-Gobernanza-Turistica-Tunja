...
<body>
	...
	<div class="container">
		...
		<!-- HEADER MODULO PROFESIONAL -->
		<div class="card border-0 shadow-sm rounded-4 mb-4" style="border-left: 6px solid #990E0B;">
				...
				<div class="d-flex align-items-center gap-3">
					...
					<div>
						...
						<small class="text-muted">
							Consulta, edición y administración de los registros almacenados en el sistema.
						</small>
					</div>
